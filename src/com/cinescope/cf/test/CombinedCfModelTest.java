...
public class CombinedCfModelTest implements CfModelTest {
	@Override
...
//        double[][] visibleData = CorrelationUtil.applyPearsonFiltering(trainMatrix, trainMatrix);
        
//        System.out.println("--- Calculating User-Based Cosine CF ---");
//        double[][] visibleData = MemoryBasedCF.applyUserCosineFiltering(trainMatrix, trainMatrix);
//        TestResult result = EvalUtil.evaluatePredictions(testMatrix, visibleData);
        
        System.out.println("--- Calculating Item-Based Cosine CF ---");
        double[][] visibleData2 = MemoryBasedCF.applyItemCosineFiltering(trainMatrix, trainMatrix);
        result = EvalUtil.evaluatePredictions(testMatrix, visibleData);
        
        visibleData = average(visibleData, visibleData2);
        result = EvalUtil.evaluatePredictions(testMatrix, visibleData);
